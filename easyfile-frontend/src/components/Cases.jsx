export default function Cases() {
  return (
    <main className="flex-1 p-8 overflow-y-auto bg-[#1f1f1f] text-white">
      <h1 className="text-2xl font-bold mb-6">Account cases</h1>
      
      {/* Tabs */}
      <div className="flex space-x-6 border-b border-gray-700 mb-4">
        <button className="pb-2 border-b-2 border-white font-medium">All</button>
        <button className="pb-2 text-gray-400 hover:text-white transition">Drafts</button>
      </div>
      ...
      {/* Table Header */}
      <div className="grid grid-cols-3 gap-4 pb-2 border-b border-gray-700 text-sm font-medium text-gray-400 mb-16">
        <div>Case</div>
