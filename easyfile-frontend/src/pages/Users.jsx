        ...
        {totalPages > 1 && (
          <div className="flex flex-wrap items-center justify-between px-6 py-4 border-t border-gray-200 dark:border-gray-800 bg-gray-50/50 dark:bg-[#1a1a1a]">
            <div className="text-sm text-gray-500 dark:text-gray-400 mb-2 sm:mb-0">
              Showing <span className="font-medium text-gray-900 dark:text-white">{((pageNumber - 1) * 20) + 1}</span> to <span className="font-medium text-gray-900 dark:text-white">{Math.min(pageNumber * 20, totalCount)}</span> of <span className="font-medium text-gray-900 dark:text-white">{totalCount}</span> users
            </div>
